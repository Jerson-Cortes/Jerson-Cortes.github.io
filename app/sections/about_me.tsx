export default function AboutMe() {
  return (
    <section id="AboutMe" className="w-full md:h-[calc(100vh-6rem)]">
      <div className="flex flex-col mt-22 relative" id="AboutMe">
        ...
        <p className="absolute right-1 top-50 text-4xl japanese writing-vertical-lr md:right-20 md:top-40">継続は力なり</p>
      </div>
    </section>
  )
}
