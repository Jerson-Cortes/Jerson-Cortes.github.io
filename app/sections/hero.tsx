  ...
  return (
    <section id="Hero">
      <div id="Hero" className="flex flex-col">
        ...
        <div className="flex flex-col order-4 pt-12 right-5 ml-auto space-y-8 font-bold">
          <a className="text-4xl ml-auto hover:text-(--red)" href="#AboutMe">[ABOUT ME]</a>
          <a className="text-4xl ml-auto hover:text-(--red)" href="#Skills">[SKILLS]</a>
          <a className="text-4xl ml-auto hover:text-(--red)" href="#Contact">[CONTACT]</a>
        </div>
      </div>
    </section>
  )
